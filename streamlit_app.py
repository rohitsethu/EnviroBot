...
background_image_url = "https://images.unsplash.com/photo-1552733407-5d5c46c3bb03?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGJsYW5rfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
...
if selected_location_sidebar:
    st.session_state["location_selected"] = True
    st.session_state["selected_location"] = selected_location_sidebar
    st.rerun()
elif "location_selected" in st.session_state and not selected_location_sidebar:
